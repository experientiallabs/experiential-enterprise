...
variable "region" {
  description = "GCP region for the trial VM."
  type        = string
  default     = "us-central1"
}

variable "zone" {
  description = "GCP zone for the trial VM."
  type        = string
...
variable "boot_disk_gb" {
  description = "Boot disk size in GB (images, builds, and the database volume all live here)."
  type        = number
  default     = 120
}
