...
output "public_ip" {
  ...
  value       = azurerm_public_ip.trial.ip_address
}

output "public_dns" {
  description = "Azure-assigned FQDN of the trial VM."
  value       = azurerm_public_ip.trial.fqdn
}
...
output "vm_admin_password" {
  description = "OS login password for the 'explabs' user (needed only if allow_ssh_cidr is set)."
