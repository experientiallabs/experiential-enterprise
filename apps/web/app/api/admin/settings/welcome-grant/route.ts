...
/**
 * Set the signup welcome grant amount (micro-USD) every new org receives.
...
export async function PUT(request: NextRequest): Promise<Response> {
  try {
    ...
    return NextResponse.json(await getDataSource().putWelcomeGrant(body!.micro_usd as number));
  } catch (error) {
